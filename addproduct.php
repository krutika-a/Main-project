...
{
$insertquery="INSERT INTO pizzas(`title`,`price`,`discription`)
values('".$_POST['title']."','".$_POST['price']."','".$_POST['discription']."')";
...
if(!$res)
				...
				{
				echo"INSERTED";
				header("Location:showprodash.php");
				}
}
?>
          ...
          <div class="d-grid align-form-map">
            <div class="form-inner-cont">
              <form action="" method="post" class="signin-form">
                  ...
                  <label for="w3lSender">Title(Required)*</label>
                  <input type="title" name="title" value=" "/>
                </div>
                <div class="form-input">
                  <label for="w3lSender">price(Required)*</label>
                  <input type="price" name="price" value=" " />
                </div>
                <div class="form-input">
                  <label for="w3lSender">Discription</label>
                  <input type="discription" name="discription" value=" " />
                </div>
